from board import ABoardState, BoardState, BitBoardState
...
OTW_BITBOARD = BitBoardState(bottom_string=otw_board_bottom_layer,
                             middle_string=otw_board_middle_layer,
                             top_string=otw_board_top_layer)
...
START_BITBOARD = BitBoardState(bottom_string=start_board_bottom_layer,
                               middle_string=start_board_middle_layer,
                               top_string=start_board_top_layer)
...
TTW_BITBOARD = BitBoardState(bottom_string=ttw_board_bottom_layer,
                             middle_string=ttw_board_middle_layer,
                             top_string=ttw_board_top_layer)
...
CROWDED_BITBOARD = BitBoardState(bottom_string=crowded_board_bottom_layer,
                                 middle_string=crowded_board_middle_layer,
                                 top_string=crowded_board_top_layer)
...
SIMPLE_BITBOARD = BitBoardState(bottom_string=simple_board_bottom_layer,
                                middle_string=simple_board_middle_layer,
                                top_string=simple_board_top_layer)
...
LOW_BITBOARD = BitBoardState(bottom_string=low_board_bottom_layer,
                             middle_string=low_board_middle_layer,
                             top_string=low_board_top_layer)
...
MID_BITBOARD = BitBoardState(bottom_string=mid_board_bottom_layer,
                             middle_string=mid_board_middle_layer,
                             top_string=mid_board_top_layer)
...
HIGH_BITBOARD = BitBoardState(bottom_string=high_board_bottom_layer,
                              middle_string=high_board_middle_layer,
                              top_string=high_board_top_layer)
